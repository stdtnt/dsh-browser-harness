...
function requirePositiveInteger(value, label, max) {
...
export function validateNavigateArgs(args) {
...
export function validateTabsArgs(args) {
...
export function validateTypeArgs(args) {
...
export function validateExtractArgs(args) {
